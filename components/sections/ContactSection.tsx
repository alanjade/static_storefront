      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <h2
              className="mt-2 text-3xl sm:text-4xl font-bold text-gray-900 mb-4"
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all group card-hover"
              >
                <div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: 'rgba(37, 211, 102, 0.1)' }}
                >
                  <MessageCircle className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: 'var(--color-primary)' }} />
                </div>
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">WhatsApp</p>
                  <p className="text-xs sm:text-sm text-gray-500 truncate">{storeConfig.phone}</p>
                </div>
                <span
                  className="ml-auto text-xs sm:text-sm font-medium flex-shrink-0"
                  style={{ color: 'var(--color-primary)' }}
                >
                  Chat Now →
                </span>
              ...
              <a
                ...
                className="flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all group card-hover"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-blue-50">
              ...
              <a
                ...
                className="flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 bg-white rounded-2xl shadow-sm hover:shadow-md transition-all group card-hover"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-purple-50">
                  <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" />
                </div>
                <div className="min-w-0">
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">Email</p>
                  <p className="text-xs sm:text-sm text-gray-500 truncate">{storeConfig.email}</p>
                </div>
              </a>
            </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 opacity-10 pointer-events-none">
                <div className="absolute top-4 right-4 w-36 sm:w-48 h-36 sm:h-48 rounded-full border-2 border-white" />
                <div className="absolute bottom-4 left-4 w-24 sm:w-32 h-24 sm:h-32 rounded-full border-2 border-white" />
              </div>

              <div className="relative z-10 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6">
                  <MessageCircle className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2" style={{ fontFamily: 'var(--font-display)' }}>
                  Ready to Order?
                </h3>
                <p className="text-white/80 mb-6 text-sm leading-relaxed max-w-xs mx-auto">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-bold text-sm sm:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
