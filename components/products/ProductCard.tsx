    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-medium text-gray-400 uppercase tracking-wide truncate mr-2">
            {product.category}
          </span>
          {product.rating && (
        ...
        {/* Price + CTA — wraps gracefully on tiny screens */}
        <div className="flex flex-wrap items-center justify-between gap-2 mt-auto">
          ...
          <a
            ...
            className={`flex items-center gap-1.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-semibold text-white transition-all hover:scale-105 active:scale-95 whitespace-nowrap ${
